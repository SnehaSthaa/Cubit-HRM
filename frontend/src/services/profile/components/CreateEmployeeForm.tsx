...
const frontendSchema = createEmployeeSchema.extend({
  ...
  // ── Number fields ──────────────────────────────────────────────────────────
  ward: z.preprocess((val) => {
    if (val === "" || val === null || val === undefined) return undefined;
    const n = Number(val);
    return isNaN(n) ? undefined : n;
  }, z.number().int("Ward must be a whole number").positive("Ward must be a positive number").optional()),

  salary: z.preprocess((val) => {
    if (val === "" || val === null || val === undefined) return undefined;
    const n = Number(val);
    return isNaN(n) ? undefined : n;
  }, z.number().positive("Salary must be greater than 0").multipleOf(0.01, "Max 2 decimal places").optional()),
...
export default function CreateEmployeeForm() {
  ...
  const errorsByStep = Object.keys(errors).reduce<Record<number, number>>(
    (acc, key) => {
  ...
  return (
    <div
      ref={formRef}
      className="max-w-4xl mx-auto my-8 p-6 bg-white rounded-xl shadow-md border border-gray-100"
    >
      ...
      >
        {STEPS.map((s, idx) => {
          ...
          const hasErrors =
            attempted.has(s.id) && (errorsByStep[s.id] ?? 0) > 0 && !isActive;
          return (
            <React.Fragment key={s.id}>
              <div className="flex flex-col items-center" role="listitem">
                ...
                <span
                  className={`text-xs font-medium mt-1.5 hidden sm:block whitespace-nowrap ${
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                <input
                  ...
                  aria-describedby={
                    errors.last_name ? "err-last_name" : undefined
                  }
              ...
              >
                <input
                  ...
                  aria-describedby={
                    errors.department_name ? "err-department_name" : undefined
                  }
              ...
              >
                <input
                  ...
                  aria-describedby={
                    errors.joining_date ? "err-joining_date" : undefined
                  }
          ...
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <Field
                ...
                errorId="err-marital_status"
              >
                <select
                  id="marital_status"
                  {...register("marital_status")}
                  aria-describedby={
                    errors.marital_status ? "err-marital_status" : undefined
                  }
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {(["country", "state", "district", "city", "tole"] as const).map(
                (key) => (
                  <Field
                    key={key}
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {(
                [
                  ...
                  },
                  {
                    ...
                    placeholder: "e.g. Active, Probation",
                  },
                  {
                    key: "hierarchy",
                    label: "Hierarchy Line",
                    placeholder: "e.g. CTO → VP Eng → Manager",
                  },
                ] as const
              ...
              <Field
                ...
                errorId="err-previous_experience"
                col2
              >
                <textarea
                  ...
                  className={
                    iCls(errors.previous_experience?.message) + " resize-none"
                  }
                />
              </Field>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                <input
                  ...
                  aria-describedby={
                    errors.account_number ? "err-account_number" : undefined
                  }
